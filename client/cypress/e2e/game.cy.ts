describe('Game Page', () => {
  ...
  it('should render game page sections', () => {
    cy.getByDataCy('game-info').within(() => {
      ...
      cy.findByText(
        /^This game is part of your Welcome Offer! Get this game for a special price just for you!Find more excellent games at great discounts/i
      ).should('exist')
      cy.findByText('$99.98').should('exist')
