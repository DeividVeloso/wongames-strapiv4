...
describe('<Heading />', () => {
  ...
  it('should render a heading with a line at the bottom and with a primary color', () => {
    render(
  ...
  it('should render a heading with a line at the bottom and with a secondary color', () => {
    render(
